...
* Security Operations and Engineering roles represent the largest workforce segments.
* Management positions receive the highest average salaries.
* The organization maintains balanced gender representation.
...
* Increase staffing in specialized security areas.
